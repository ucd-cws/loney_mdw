...
In 2019,  Loney Meadow and several adjacent lentic ponds or lake habitats nearby surveyed (Figure 2). Each site was visited during clear and sunny conditions, and was thoroughly surveyed. The stockpond, Bullpen Lake, and unnamed pond (NE) and (E) did not appear to have changed in structure or condition between visits, and since previous visits in 2016.

```{r fig2, fig.cap="Map of Survey Sites", fig.align='center', out.width='100%', message=FALSE, warning=FALSE}
...
```{r, fig3, fig.cap="Lentic unnamed pond east of Loney Meadow", fig.align='center', out.width='50%', message=FALSE, warning=FALSE}
...
In 2019, surveys found primarily Pacific chorus frogs (*Pseudacris regilla*) [PSRE] in multiple life stages (eggs, tadpoles and adults were observed), however, Southern long-toed salamanders (*Ambystoma macrodactylum sigillatum*) [AMMASI] larvae were observed again in the small pond just northeast of the main Loney Meadow (Figure 2). This is the same location they were observed in 2016 as well. The AMMASI larvae were observed in a small unnamed pond at an elevation approximately 100 meters higher than Loney Meadow. There was no evidence of grazing or cattle at the unnamed pond. The only other herpetofauna observed were Sierra and wandering gartersnakes (*Thamnophis couchii* [THCO] and *Thamnophis elegans* [THEL]). Both of these species were observed in multiple locations within the area, similar to 2015 and 2016. There were no new species observed in 2019 that were not observed in 2015 or 2016.

```{r, fig4, fig.cap="Map of amphibian species observations 2019.", fig.align='center', out.width='100%', message=FALSE, warning=FALSE}
